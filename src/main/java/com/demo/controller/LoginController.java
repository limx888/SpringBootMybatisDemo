...
import com.demo.config.ShiroConfiguration;
...
public class LoginController {
    ...
    @GetMapping(value = "/hello_login")
    public String hello() {
        log.info("不登录也可以访问...");
        return "hello_login...";
    }

    @GetMapping(value = "/index_login")
    public String index() {
        log.info("登录成功了...");
        return "index_login";
    }
    ...
    public String login(String username, String password, RedirectAttributes model) {
        // 想要得到SecurityUtils.getSubject() 的对象.. 访问地址必须跟 shiro 的拦截地址内，不然会报空指针
