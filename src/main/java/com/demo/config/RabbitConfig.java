...
public class RabbitConfig {
     ...
     * 延迟队列 TTL 名称
     */
    private static final String DELAY_ADDRESSLIST = "delayAddressList";

    /**
     * DLX，dead letter发送到的 exchange
     * TODO 此处的 exchange 很重要,具体消息就是发送到该交换机的
     */
    public static final String DELAY_EXCHANGE_ADDRESSLIST = "exchangeAddressList";
    ...
    public static final String REGISTER_QUEUE_NAME = "addresslist.register.queue";
    public static final String REGISTER_EXCHANGE_NAME = "addresslist.register.exchange";
    ...
    public Queue delayProcessQueue() {
        ...
        return new Queue(DELAY_ADDRESSLIST, true, false, false, params);
    }
    ...
    public DirectExchange delayExchange() {
        return new DirectExchange(DELAY_EXCHANGE_ADDRESSLIST);
    }
    ...
    @Bean
    public Queue registerAddressListQueue() {
    ...
    public Binding registerBookBinding() {
        ...
        return BindingBuilder.bind(registerAddressListQueue()).to(registerBookTopicExchange()).with(ROUTING_KEY);
    }

    @Bean
    public Queue addressListQueue() {
        // 第一个是 QUEUE 的名字,第二个是消息是否需要持久化处理
        return new Queue("AddressList", true);
    }

    @Bean
    public Queue addressListAckQueue() {
        // 第一个是 QUEUE 的名字,第二个是消息是否需要持久化处理
        return new Queue("ackAddressList", true);
    }

    @Bean
    public Queue addressListAutoQueue() {
        // 第一个是 QUEUE 的名字,第二个是消息是否需要持久化处理
